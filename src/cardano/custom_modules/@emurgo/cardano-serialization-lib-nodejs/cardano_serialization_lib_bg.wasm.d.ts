...
export function transactionbuilderconfigbuilder_price_mem(a: number, b: number): number;
export function transactionbuilderconfigbuilder_price_step(a: number, b: number): number;
...
export function transactionbuilder_set_mint(a: number, b: number, c: number): void;
...
export function transactionbuilder_add_mint_asset_and_output(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function transactionbuilder_add_mint_asset_and_output_min_required_coin(a: number, b: number, c: number, d: number, e: number): void;
