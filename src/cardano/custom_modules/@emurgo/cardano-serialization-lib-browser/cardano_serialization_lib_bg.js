...
export class TransactionBuilder {
  ...
  set_mint_asset(policy_script, mint_assets) {
    ...
    wasm.transactionbuilder_set_mint_asset(
      this.ptr,
      policy_script.ptr,
      mint_assets.ptr
    );
  ...
  add_mint_asset(policy_script, asset_name, amount) {
    ...
    var ptr0 = amount.ptr;
    amount.ptr = 0;
    wasm.transactionbuilder_add_mint_asset(
      this.ptr,
      policy_script.ptr,
      asset_name.ptr,
      ptr0
  ...
  add_mint_asset_and_output(
    ...
    wasm.transactionbuilder_add_mint_asset_and_output(
      this.ptr,
      policy_script.ptr,
      asset_name.ptr,
      ptr0,
  ...
  add_mint_asset_and_output_min_required_coin(
    ...
    amount.ptr = 0;
    _assertClass(output_builder, TransactionOutputAmountBuilder);
    wasm.transactionbuilder_add_mint_asset_and_output_min_required_coin(
      this.ptr,
      policy_script.ptr,
      asset_name.ptr,
      ptr0,
...
export class TransactionBuilderConfigBuilder {
   ...
   */
  price_mem(price_mem) {
    var ret = wasm.transactionbuilderconfigbuilder_price_mem(
      this.ptr,
      price_mem
    );
    return TransactionBuilderConfigBuilder.__wrap(ret);
  ...
  price_step(price_step) {
    var ret = wasm.transactionbuilderconfigbuilder_price_step(
      this.ptr,
      price_step
    );
    return TransactionBuilderConfigBuilder.__wrap(ret);
  ...
  costmdls(costmdls) {
    ...
    var ptr0 = costmdls.ptr;
    costmdls.ptr = 0;
    var ret = wasm.transactionbuilderconfigbuilder_costmdls(this.ptr, ptr0);
    return TransactionBuilderConfigBuilder.__wrap(ret);
  }
  /**
  ...
  prefer_pure_change(prefer_pure_change) {
    var ret = wasm.transactionbuilderconfigbuilder_prefer_pure_change(
      this.ptr,
      prefer_pure_change
    );
    return TransactionBuilderConfigBuilder.__wrap(ret);
...
export class TransactionOutputBuilder {
  ...
  with_data_hash(data_hash) {
    _assertClass(data_hash, DataHash);
    var ret = wasm.transactionoutputbuilder_with_data_hash(
      this.ptr,
      data_hash.ptr
    );
    return TransactionOutputBuilder.__wrap(ret);
